#include <Core/Algorithms/Math/ShowDensityProjectionAlgo.h>
...
ShowDensityProjectionAlgo::ShowDensityProjectionAlgo()
{
...
AlgorithmOutput
ShowDensityProjectionAlgo::run(const AlgorithmInput& input) const
{
...
bool
ShowDensityProjectionAlgo::Sort(DenseMatrixHandle input, DenseMatrixHandle& output, int method) const
{
  if (!input)
  {
...
bool
ShowDensityProjectionAlgo::Quicksort(double* input, index_type lo, index_type hi) const
{
...
index_type
ShowDensityProjectionAlgo::Partition(double* input, index_type lo, index_type hi) const
{
